...
class AlchemyMeasures:
    ...
    def m_stone_rotation(stone_rotation):
        # TODO: It's a list/array for some reason...
    ...
    def i_parity_first_stone():
        return MeasureInfo(
            full_range      = (-0.5, 7.5),
            sample_range    = (2.5, 7),  # TODO: why is this weird? Starts around 3 in the plot
            max_cells       = 8,
            sample_dist     = 'uniform',
    ...
    def m_parity_first_stone(stone_latent_states):
        # convert from {-1, 1}^3 to int
        first_latent = (stone_latent_states[0][0] + 1.0)/2
    ...
    def compute_measures(stone_latent_states=None, 
        ...
        # Reshape to (trials, stones, latent_state_dim)
        # stone_latent_states = np.array(stone_latent_states).reshape(-1, 3, 3)  # TODO!
