...
def get_parser(use_rl2):
    ...
    parser.add_argument("--plr-replay-prob", type=float,default=1.0, help="Probability of replaying a level instead of a new level.")
    ...
    parser.add_argument('--qd-initial-population',      type=int_arg,   default=100)  
    # QD hyperparams
