...
def get_common_rl2_arg_parser():
    ...
    # --- ALCHEMY ---
    parser.add_argument('--gt-type', default='s10-d-d-d-c6', help='Genotype type')
    ...
    parser.add_argument('--num-processes', type=int, default=16, help='how many training CPU processes / parallel environments to use (default: 16)')
