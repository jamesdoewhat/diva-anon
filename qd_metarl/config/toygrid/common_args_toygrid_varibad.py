...
# Common args for toygrid env

def get_common_arg_parser():
    parser = argparse.ArgumentParser(conflict_handler='resolve')

    # --- GENERAL ---
    parser.add_argument('--num-frames', type=int_arg, default=1e7,  help='number of frames to train')
    ...
    parser.add_argument('--gt-type', default='natural', help='Genotype type')
    ...
    parser.add_argument("--plr-seed-buffer-size",type=int,default=45, help="Number of levels to store in our buffer, after which we replace")
