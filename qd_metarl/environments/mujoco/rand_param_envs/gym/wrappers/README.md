...
from qd_metarl.environments.mujoco2.rand_param_envs.gym.wrappers import MyWrapper
```

## How to add new wrappers to Gym

1. Write your wrapper in the wrappers' top-level folder.
2. Import your wrapper into the `__init__.py` file. This file is located at `/gym/wrappers/__init__.py`. Add `from qd_metarl.environments.mujoco2.rand_param_envs.gym.wrappers.my_awesome_wrapper import MyWrapper` to this file.
