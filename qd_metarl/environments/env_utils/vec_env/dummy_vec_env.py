...
from qd_metarl.environments.env_utils.vec_env import VecEnv
from qd_metarl.environments.env_utils.vec_env.util import copy_obs_dict, dict_to_obs, obs_space_info
...
class DummyVecEnv(VecEnv):
    ...
    def __init__(self, env_fns):
        ...
        self._max_trial_steps = env.unwrapped._max_trial_steps
